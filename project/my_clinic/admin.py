...
class ProfilePatinetView(BaseView):
    ...
    def index(self):
        ...
        getPatient = dao.get_profile_customer(name_patient= name_patient)
        if getPatient:
            mes = "co du lieu"
...
class GetDetailView(BaseView):
    ...
    def index(self):
        ...
        getDetail = dao.get_name_receipt_detail(name)
        if getDetail:
            mes = "Valid data!"
...
class DetailByDateView(BaseView):
    ...
    def index(self):
        ...
        detail_date = dao.get_all_detail_by_date(date1=date1, date2=date2)
        totaldetail_date = dao.get_totaldetail_by_date(date1=date1, date2=date2)
